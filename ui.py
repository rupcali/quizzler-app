...
class UserInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(text="Score: 0", bg=THEME_COLOR, fg="white", font=("Helvetica", 12))
        ...
        self.false_button = Button(image=false_image, highlightthickness=0, bg=THEME_COLOR, command=self.false_pressed)
